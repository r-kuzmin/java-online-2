...
public class Task13 {
    public static void main(String[] args) {
        int[][] array = getRandomMatrix(5, 7, 100);
        ...
        int[][] transArray = transposeMatrix(array);

        sortMatrixString(transArray, true);

        array = transposeMatrix(transArray);
     ...
     * @return - новая матрица, полученная из исходной.
     */
